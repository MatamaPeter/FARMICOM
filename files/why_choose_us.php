        ...
        <section class="testimonials-three">
            <div class="container">
                ...
                <div class="testimonials-three__carousel thm__owl-carousel light-dots owl-carousel owl-theme"
                    data-options='{"nav": false, "autoplay": true, "autoplayTimeout": 5000, "smartSpeed": 700, "dots": false, "margin": 30, "loop": true, "responsive": { "0": { "items": 1, "nav": true, "navText": ["Prev", "Next"], "dots": false }, "767": { "items": 1, "nav": true, "navText": ["Prev", "Next"], "dots": false }, "991": { "items": 2 }, "1199": { "items": 2 }, "1200": { "items": 3 } }}'>
                    <div class="item">
                        <div class="testimonials-three__single">
                            <div class="testimonials-three__content">
                                ...
                                <p>Farmicom exceeded my expectations for organic farming. it's a movement towards a greener, 
                    ...
                    <div class="col-xl-8">
                        <div class="benefits_text">
                            <p>Experience elevated farming with Farmicom – where seamless online shopping, 
                                ...
                                and foster a supportive agricultural community.</p>
                        </div>
                    </div>
                </div>
                            ...
                            <ul class="why_choose_list list-unstyled">
                                <li>
                                    ...
                                    <div class="choose_text">
                                        <p>Plow the seeds of knowledge, irrigate with care, and cultivate a sustainable legacy – Better Agriculture for a Better Future.</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="choose_count">
                                    ...
                                    <div class="choose_text">
                                        <p>Nourish the land, empower the farmer, and watch fields bloom with abundance – Better Agriculture for a Better Future.</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="choose_count">
                                    ...
                                    <div class="choose_text">
                                        <p>Cultivate innovation, sow sustainability, reap a harvest of prosperity – Better Agriculture for a Better Future.</p>
                                    </div>
                                </li>
                            </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="company_solutions_single">
                            ...
                            <p>Explore the essence of freshness with Farmicom's bountiful selection of farm-to-table delights.</p>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4">
                        <div class="company_solutions_single">
