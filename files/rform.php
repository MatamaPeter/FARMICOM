...
<html lang="en">
<head>
	<title>Farmicom Registration V1</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				if($Validate_user -> num_rows !==0){
					echo"<div class='message'><p class='wrap-input100 validate-input'>User already registered</p>
					<a href='javascript:self.history.back()'><button class='login100-form-btn'>Go back</div>";
				}else{
					mysqli_query($con,"INSERT INTO users(Username, Email, Phone, Password)VALUES('$username', '$Email', '$Phone', '$Hashed_password')");
					echo"<div class='login100-form validate-form'><p class='wrap-input100 validate-input' >User Successfully registered</p>
					<a href='lform.php'><button class='login100-form-btn'>Login</div>";
				}
			}
				...
				<form class="login100-form validate-form" method="post" action="">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" name="registrationbtn">
							Create Account
						</button>
					</div>
