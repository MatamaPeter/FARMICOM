        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <a href="addProducts.php"><button type="button" class="btn-add-farmer btn-icon-text">
                            <i class="mdi mdi-file-plus btn-icon-prepend"></i> New product </button></a>
                      ...
                      <?php
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="<?php echo $product_dtls['Product_img']?>" alt="image" />
                          </td>
