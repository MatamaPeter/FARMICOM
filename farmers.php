...
<html lang="en">
    ...
    <div class="container">
        <div class="row">
            <?php
                     $farmers_data = mysqli_query($con, "SELECT * FROM farmers") or die ("query failed");
    ...
    <div class="side-menu__block">
        ...
        <div class="side-menu__block-inner ">
            ...
            <div class="side-menu__content">
                <p><a href="info@farmicom.com">info@farmicom.com</a> <br> <a href="tel:254-712-3456">+254 712 345
                    678</a></p>>
